...
module.exports = {
    ...
    class Room {
        ...
        generateGameState(player){
            ...
            if (player === "p1") {
                r = {
                    id: this.id,
                    ended: this.ended,
                    p1: {pawns: this.p1.pawns, name: this.p1.name, you: true, turn: this.p1.turn, connected: this.p1.socket.connected, area: this.p1.area, rematchWanted: this.p1.rematchWanted},
                    p2: {pawns: this.p2.pawns, name: this.p2.name, you: false, turn: this.p2.turn, connected: this.p2.socket.connected, area: this.p2.area, rematchWanted: this.p2.rematchWanted},
                ...
                r = {
                    id: this.id,
                    ended: this.ended,
                    p1: {pawns: this.p1.pawns, name: this.p1.name, you: false, turn: this.p1.turn, connected: this.p1.socket.connected, area: this.p1.area, rematchWanted: this.p1.rematchWanted},
                    p2: {pawns: this.p2.pawns, name: this.p2.name, you: true, turn: this.p2.turn, connected: this.p2.socket.connected, area: this.p2.area, rematchWanted: this.p2.rematchWanted},
                    gameBoard: this.gameBoard,
                    pawnReserve: this.pawnReserve
                };
        ...
        resetGame(){
            ...
            this.p2.pawns = {white:2, black: 2};
            this.p1.turn = false;
            this.p2.turn = false;
            this.p1.rematchWanted = false;
            this.p2.rematchWanted = false;
        }
        findWinner(){
